...
from utils.analyze_pdf import get_pdf_pages_as_images, get_crop_box_pixel, get_crop_boxes
...
class CropWorker(QRunnable):
    ...
    @pyqtSlot()
    def run(self):
        images, pts_width, pts_height, index = get_pdf_pages_as_images(self.path_to_pdf,
